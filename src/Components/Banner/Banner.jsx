...
const Banner = () => {
    ...
    return (
        <div className="relative w-full h-screen overflow-hidden select-none">
            ...
            <div className={`relative md:max-w-2xl lg:max-w-4xl 2xl:max-w-7xl mx-auto z-20 ${textColorClass}`}>
                ...
                <div className=''>
                    ...
                    <div className='md:flex flex-row-reverse justify-between lg:-mt-8 '>
                        ...
                        <p className={`w-96 text-lg md:mt-4 lg:mt-8 text-justify px-4 ${textColorClass}`}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos cupiditate adipisci labore obcaecati sunt laudantium cum beatae qui. Inventore, consequatur.</p>
                    </div>
                </div>
            </div>
            <button
            ...
            <div className='float-right 2xl:-mt-10'>
