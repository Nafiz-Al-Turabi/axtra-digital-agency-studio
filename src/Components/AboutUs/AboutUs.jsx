...
const AboutUs = () => {
    ...
    return (
        <div className='bg-[#121212] py-20 overflow-hidden'>
            <div className='md:flex lg:flex 2xl:flex justify-between max-w-7xl mx-auto'>
            <div 
                    className='w-full md:w-1/2 lg:w-1/2 2xl:w-1/2 mt-32'
                    style={{
                ...
                <div className='text-white p-4 md:w-1/2'>
                    ...
                    <div className=''>
                        <p className='text-xl text-gray-500 text-justify'>We’re a team of strategic digital marketers
